...
import com.generals.zimmerfrei.overview.BuildConfig
...
class TimetableLayoutManager(
    ...
    override fun onLayoutChildren(recycler: RecyclerView.Recycler, state: RecyclerView.State) {
        ...
        val restoredPeriod = (savedState?.position
                ?: anchor.top.get(anchor.leftColumn, -1)).let(periods::getOrNull)
    ...
    private fun fillHorizontalChunk(
        ...
        for (nextColumnNum in range) {
            val startPeriod = calculateStartPeriodInColumn(nextColumnNum, baseY, basePeriod)
                    ?: continue
    ...
    private fun recycleLeft(recycler: RecyclerView.Recycler) {
    ...
    private fun recycleRight(recycler: RecyclerView.Recycler) {
    ...
    private fun fixBottomLayoutGap(recycler: RecyclerView.Recycler) {
